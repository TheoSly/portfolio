...
export default function Nathanmaurer() {
        ...
        <section onClick={handleClick}
            ...
            <div className={`absolute top-4 left-6 right-6 z-10 text-white text-sm transition-opacity duration-700 ${
                ...
                <p className="text-sm xl:text-base whitespace-normal break-words">
                    Site vitrine développé et intégré en freelance pour Nathan Maurer, photographe et vidéaste. Réalisé
                    en PHP natif, avec des animations fluides basées sur GSAP, ce site met en avant ses travaux photos
                    et vidéos à travers une navigation immersive et dynamique.
                </p>
            ...
            <div className="absolute bottom-6 left-6 z-10">
                <h2 className="text-white text-2xl nohemi font-bold">Nathan-maurer<span className="font-extralight">.fr</span></h2>
            </div>
            <div className="absolute bottom-6 right-6 z-10">
                <a href="https://www.nathan-maurer.fr" target="_blank" rel="noopener noreferrer"
            ...
            <img className="h-full object-cover object-top rounded-2xl w-full absolute top-0 left-0 opacity-80 z-0"
                src="images-projet/website-nathanmaurer.jpg" alt="" />
        </section>
    </>
    );
    }