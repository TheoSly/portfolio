...
export default function Cuxdesign() {
        ...
        <section onClick={handleClick}
            ...
            <div className={`absolute top-4 left-6 right-6 z-10 text-white text-sm transition-opacity duration-700
                ...
                <p className="text-sm xl:text-base whitespace-normal break-words">
                    Site vitrine développé et intégré en freelance pour CUX Design, afin de présenter ses services en
                    UI/UX design. Réalisé sous WordPress avec Elementor, en mettant l’accent sur une mise en page épurée
                    et claire pour valoriser l’expertise en design d’interface et expérience utilisateur.
                </p>
            ...
            <div className="absolute bottom-6 left-6 z-10">
                <h2 className="text-white text-2xl nohemi font-bold">Cux-design<span className="font-extralight">.fr</span></h2>
            </div>
            <div className="absolute bottom-6 right-6 z-10">
                <a href="https://cux-design.fr" target="_blank" rel="noopener noreferrer"
            ...
            <img className="h-full object-cover object-top rounded-2xl w-full absolute top-0 left-0 opacity-80 z-0"
                src="images-projet/website-cuxdesign.jpg" alt="" />
        </section>
    </>
    );
    }