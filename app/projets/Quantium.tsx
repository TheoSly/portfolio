        ...
        <section onClick={handleClick}
            ...
            <div className={`absolute top-4 left-6 right-6 z-10 text-white text-sm transition-opacity duration-700 ${
                ...
                <p className="text-sm xl:text-base whitespace-normal break-words">
                    Jeu RPG développé en freelance en JavaScript avec p5.js, inspiré des jeux Pokémon Game Boy/DS.
                    Exploration 2D avec multi-cartes, combats au tour par tour, et gestion des collisions. Le choix de
                    p5.js permet une liberté totale sur le gameplay et la programmation. Graphismes pixel art
                    minimalistes, cartes créées avec Tiled et exportées en JSON.
                </p>
            ...
            <div className="absolute bottom-6 right-6 z-10">
                <a href="https://youtu.be/pDBhlBCGoEA" target="_blank"
