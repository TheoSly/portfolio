        ...
        <section onClick={handleClick}
            ...
            <div className={`absolute top-4 left-6 right-6 z-10 text-white text-sm transition-opacity duration-700 ${
                ...
                <p className="text-sm xl:text-base whitespace-normal break-words">
                    Site vitrine réalisé en freelance pour l’entreprise Xtremdrift, spécialisée dans le drift automobile. Conçu avec WordPress et Elementor Pro, il intègre de nombreuses animations interactives pour offrir une expérience utilisateur moderne et immersive.
                </p>
            ...
            <div className="absolute bottom-6 left-6 z-10">
                <h2 className="text-white text-2xl nohemi font-bold">Extrem-drift<span className="font-extralight">.com</span></h2>
            </div>
            <div className="absolute bottom-6 right-6 z-10">
                <a href="https://www.xtrem-drift.com" target="_blank" rel="noopener noreferrer"
            ...
            <img className="h-full object-cover object-top rounded-2xl w-full absolute top-0 left-0 opacity-80 z-0"
                src="images-projet/website-extremdrift.jpg" alt="" />
        </section>
    </>
    );
    }