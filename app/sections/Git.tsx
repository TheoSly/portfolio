...
return (
<>
    <section className="grayscale hover:grayscale-0 focus:grayscale-0 active:grayscale-0 transition duration-300 pointer-events-auto bg-mediumgray bg-opacity-60 backdrop-blur-md p-4 rounded-2xl border-1 border-border m-[2vw] md:m-[1.5vw] xl:m-[1vw]">
