...
return (
<>
    <section className="grayscale hover:grayscale-0 transition duration-300 pointer-events-auto bg-mediumgray rounded-2xl border-1 border-border m-[2vw] md:m-[1.5vw] xl:m-[1vw] relative overflow-hidden">
