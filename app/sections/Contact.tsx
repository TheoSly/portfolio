  ...
  return (
    <section className="flex flex-col justify-between bg-mediumgray bg-opacity-60 backdrop-blur-md p-4 rounded-2xl border-1 border-border m-[2vw] md:m-[1.5vw] xl:m-[1vw]">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <button type="submit" className="w-25 bg-white text-darkgray rounded-md px-3 py-1 mt-2 hover:scale-105 transition duration-300 cursor-pointer pointer-events-auto">
          Envoyer
        </button>
