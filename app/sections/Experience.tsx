    ...
    <section className="md:min-h-76 xl:min-h-84 bg-mediumgray bg-opacity-60 backdrop-blur-md p-4 rounded-2xl border-1 border-border m-[2vw] md:m-[1.5vw] xl:m-[1vw]">
        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-10 mt-4">
                ...
                <div>
                    <h3 className="text-xs xl:text-sm">‎ ‎ ‎ Développeur back - SEW Usocome</h3>
                    <p className="text-lightgray text-xs xl:text-sm">‎ ‎ ‎ Contact en alternance - Haguenau</p>
                </div>
            </div>
            ...
            <div className="flex gap-10">
                ...
                <div>
                    <h3 className="text-xs xl:text-sm">Développeur front - Marketify</h3>
